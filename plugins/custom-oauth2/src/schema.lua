    ...
    fields = {
        ...
        { config = {
            ...
            fields = {
                ...
                { web_token_expiration = { type = "number", default = 3600, required = true }, },
                { mobile_token_expiration = { type = "number", default = 600, required = true }, },
                ...
                { web_refresh_token_ttl = { type = "number", default = 3600, required = true }, },
                { mobile_refresh_token_ttl = { type = "number", default = 900, required = true }, },
